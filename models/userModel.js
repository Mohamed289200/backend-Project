...
const userSchema = mongoose.Schema(
	{
		...
		email: {
			...
			maxLength: [
				150,
				"Email size MUST NOT exceed 1500 characters,got {VALUE}",
			],
			trim: true,
		},
		password: {
		...
		phone: {
			...
			maxLength: [20, "Phone number MUST NOT exceed 20 numbers,got {VALUE}"],
		},
		city: {
			type: String,
			require: [true, "City is required"],
			maxLength: [30, "City MUST NOT exceed 20 numbers,got {VALUE}"],
		},
		country: {
			type: String,
			require: [true, "Country is required"],
			maxLength: [30, "Country MUST NOT exceed 20 numbers,got {VALUE}"],
		},
		role: {
			type: String,
